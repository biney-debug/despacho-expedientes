...
- Los colores superan el ratio mínimo 4.5:1 contra fondo (primario #6e1423 ≈ 11.7:1, muted #555555 ≈ 7.3:1, error #b3261e ≈ 6.2:1).
...
**Limpieza de iconografía:** se quitaron los emojis usados como iconos en el acordeón de orientación de trámites y la regla CSS `.tramite-icono` asociada.
...
**Instrucciones de despliegue:** se reescribió la sección de instalación como "Despliegue en 3 pasos" (clonar, configurar `.env`, `docker compose up`), aclarando que no se requiere instalar Node.js ni dependencias manualmente — la imagen del backend las instala durante el build.
